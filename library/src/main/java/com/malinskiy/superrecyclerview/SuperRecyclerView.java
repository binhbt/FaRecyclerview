...
public class SuperRecyclerView extends FrameLayout {
    ...
    public void transferAttrsToSuperRecyclerView(boolean mClipToPadding, int mPadding,
        ...
        this.mClipToPadding = mClipToPadding;
        ...
        this.mScrollbarStyle = mScrollbarStyle;
        if (mEmptyId != 0) this.mEmptyId = mEmptyId;
        if (mMoreProgressId != 0) this.mMoreProgressId = mMoreProgressId;
        if (mProgressId != 0) this.mProgressId = mProgressId;

        //inflate
        mProgress.setLayoutResource(this.mProgressId);
        mProgressView = mProgress.inflate();
        mMoreProgress.setLayoutResource(this.mMoreProgressId);
        if (this.mMoreProgressId != 0)
            mMoreProgressView = mMoreProgress.inflate();
        mMoreProgress.setVisibility(View.GONE);

        mEmpty.setLayoutResource(this.mEmptyId);
        if (this.mEmptyId != 0)
            mEmptyView = mEmpty.inflate();
        mEmpty.setVisibility(View.GONE);
    ...
    public void showLoadMore(boolean isShow){
        mMoreProgress.setVisibility(isShow?View.VISIBLE:View.GONE);
    }
    public void disableRefresh(){
        mPtrLayout.setDistanceToTriggerSync(999999);
    }
